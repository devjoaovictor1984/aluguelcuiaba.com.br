...
// Base URL a partir do host real da requisição (evita mismatch apex/www, que
// quebrava o iframe do PDF). Cai pra env só se não houver host.
async function baseUrlDaRequisicao(): Promise<string> {
