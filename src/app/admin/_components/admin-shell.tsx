...
import {
  ...
  FileDown, Settings, ExternalLink, Menu, X, LogOut, ShieldCheck, Tag, LayoutList, Mail, Map, Bell, BarChart3, HelpCircle, Lightbulb, FlaskConical,
} from 'lucide-react'
...
const NAV = [
  ...
  { href: '/admin/envios', label: 'Envios', icon: BarChart3 },
  ...
  { href: '/admin/homologacao', label: 'Homologação', icon: FlaskConical },
  { href: '/admin/ajuda', label: 'Ajuda CRM', icon: HelpCircle },
