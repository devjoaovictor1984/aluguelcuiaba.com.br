...
export default async function Home({ searchParams }: Props) {
  ...
  return (
    <>
      ...
      {/* Mapa hero do desktop. O MapaImoveisWrapper só monta o Leaflet quando
          o container intersecta a viewport — como aqui é hidden md:block,
          no mobile (display:none) ele nunca monta (sem o crash do Leaflet em
          container zero) e a altura fica reservada (sem CLS). */}
