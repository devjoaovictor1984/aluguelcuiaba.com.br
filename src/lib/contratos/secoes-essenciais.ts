...
export const SECOES_ESSENCIAIS: SecaoEssencial[] = [
  ...
  { id: 'garantia',      label: 'Garantia',             categorias: ['garantia'] },
  { id: 'vistoria',      label: 'Vistoria / Chaves',    categorias: ['vistoria', 'chaves'] },
  { id: 'obrigacoes',    label: 'Obrigações',           categorias: ['obrigacoes_loc', 'obrigacoes_adm', 'obrigacoes_locador'] },
  { id: 'rescisao',      label: 'Rescisão e multa',     categorias: ['rescisao'] },
  { id: 'manutencao',    label: 'Manutenção e benfeitorias', categorias: ['manutencao', 'benfeitorias', 'reforma'] },
