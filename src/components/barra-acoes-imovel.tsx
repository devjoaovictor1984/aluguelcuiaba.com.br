...
export function BarraAcoesImovel({ imovel }: { imovel: Imovel }) {
  ...
  return (
    /* lg:hidden → só aparece no mobile/tablet */
    <div
    ...
    >
      {/* WhatsApp — botão principal, grande, thumb-friendly */}
      <a
        href={linkWpp}
        target="_blank"
      ...
      <button
        ...
        className="w-16 flex flex-col items-center justify-center gap-0.5 border-2 border-gray-200 rounded-2xl text-gray-500 hover:border-violet-300 hover:text-violet-600 active:bg-gray-50 transition-colors"
